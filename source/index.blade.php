        ...
        <div class="container">
            ...
            <div class="m-xs-b-7">
                ...
                <ul class="projects no-list-style">
                    ...
                    <li><a href="/status-code-poster/status-code-poster/">HTTP Status Code Poster<svg width="12" height="7" viewBox="0 0 12 7" xmlns="http://www.w3.org/2000/svg"><path class="icon-link" d="M9.293 3H0v1h9.293L7.146 6.146l.708.708L11.207 3.5 7.854.146l-.708.708L9.293 3" fill-rule="evenodd"/></svg></a></li>
